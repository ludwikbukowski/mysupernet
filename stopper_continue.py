...
parser.add_argument('--init_epoch', '-i', help="numer of epochs to iterate", type= int, default=100)
parser.add_argument('--batch-size', '-b', help="batch size", type= int, default=32)
parser.add_argument('--model', '-m', help="model to continue learning", type= str, default='')
...
save_experiment(parameters_passed,save_dir, history, model, epochs, batch_size, 1, scores, notes)
